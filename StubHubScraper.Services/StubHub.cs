    ...
    public class StubHub
    {
        ...
        public static List<string> GetEventZones(int eventId, string token)
        {
            ...
            if (resp.StatusCode == HttpStatusCode.OK && resp.Data != null && resp.Data.zone_stats != null)
            {
                ...
                {
                    results.Add("totalTickets:" + resp.Data.totalTickets.ToString());
                }

                if (resp.Data.eventPricingSummary != null)
                {
                    results.Add("minTicketPrice:" + resp.Data.eventPricingSummary.minTicketPrice.ToString());
                }
                else
                {
                    results.Add("minTicketPrice:0");
                }
            }
